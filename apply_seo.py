...
files_config = {
    'index.html': {
        'title': 'PARAFFIN — Creative Direction & Digital Production',
    ...
    'contact.html': {
        'title': 'Contact — PARAFFIN',
        'desc': 'Connect with PARAFFIN for global transmissions and high-end creative partnerships.'
    },
    'privacy.html': {
        'title': 'Privacy Policy — PARAFFIN',
        'desc': 'Privacy and data protection policies for the PARAFFIN platform.'
    },
    'terms.html': {
        'title': 'Terms of Service — PARAFFIN',
        'desc': 'Terms and conditions for using the PARAFFIN platform.'
    }
}

fr_files_config = {
    'fr/index.html': {
        'title': 'PARAFFIN — Direction Créative & Production Digitale',
    ...
    'fr/contact.html': {
        'title': 'Contact — PARAFFIN',
        'desc': 'Contactez PARAFFIN pour des transmissions mondiales et des partenariats créatifs haut de gamme.'
    }
}
